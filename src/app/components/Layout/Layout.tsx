      ...
      <div className="flex w-full">
        ...
        <div className="hidden md:flex md:flex-row md:fixed bg-white justify-center items-center w-full shadow-lg shadow-gray-100 py-4 px-8 ">
          <div className="flex items-center justify-around w-full gap-4">
            ...
            <div className="w-1/2 rounded-full bg-orange-100 border border-orange-300 px-6 py-2">Знайти</div>
            <img className={`w-10 h-10 rounded-full stroke-black fill-black hover:bg-orange-100 cursor-pointer ${isAuth ? "flex" : "hidden"}`} src={User} alt="" />
