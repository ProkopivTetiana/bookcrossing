    ...
    <Layout>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex justify-around flex-wrap gap-8 w-full">
          <NavLink
            to={"/advertisements/category/name/0"}
          ...
          <NavLink
            to={"/advertisements/category/name/1"}
            className="flex justify-center rounded-xl border-dashed cursor-pointer border-2 border-orange-600 py-4 w-3/12 hover:bg-orange-100"
          >
            Детективи
          </NavLink>
          <NavLink
            to={"/advertisements/category/name/2"}
            className="flex justify-center rounded-xl border-dashed cursor-pointer border-2 border-orange-600 py-4 w-3/12 hover:bg-orange-100"
          >
            Триллер
          </NavLink>
          <NavLink
            to={"/advertisements/category/name/3"}
            className="flex justify-center rounded-xl border-dashed cursor-pointer border-2 border-orange-600 py-4 w-3/12 hover:bg-orange-100"
          >
            Класична проза
          </NavLink>
          <NavLink
            to={"/advertisements/category/name/4"}
            className="flex justify-center rounded-xl border-dashed cursor-pointer border-2 border-orange-600 py-4 w-3/12 hover:bg-orange-100"
          >
            Сучасна проза
          </NavLink>
          <NavLink
            to={"/advertisements/category/name/5"}
            className="flex justify-center rounded-xl border-dashed cursor-pointer border-2 border-orange-600 py-4 w-3/12 hover:bg-orange-100"
          >
            Романтика
          </NavLink>
